...
namespace XboxAuthNet.Platforms.WinForm
{
    internal class WinFormsPanelWithWebView2 : Form
    {
        ...
        private IMicrosoftOAuthUriChecker? _uriChecker;
        ...
        public MicrosoftOAuthCode DisplayDialogAndInterceptUri(Uri uri, IMicrosoftOAuthUriChecker uriChecker, CancellationToken cancellationToken)
        {
            ...
            if (_authCode == null)
                throw new InvalidOperationException("_authCode was null");
        ...
        private bool CheckForEndUrl(Uri url)
        {
            ...
            var result = _uriChecker.CheckOAuthUri(url);

            if (result.IsAuthResultFound)
            {
                // This should close the dialog
                DialogResult = DialogResult.OK;
                _authCode = result.OAuthCode;
                _uriChecker = null;
            }

            return result.IsAuthResultFound;
        }
